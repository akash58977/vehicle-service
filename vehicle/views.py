...
# ============================================================
# FORGOT PASSWORD — Username-based reset (no SMTP needed)
# ============================================================

def forgot_password_view(request):
    """Step 1: User submits their username. If found, redirect to reset page."""
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'vehicle/forgot_password.html', {
                'error': 'No account found with that username. Please check and try again.'
            })
    return render(request, 'vehicle/forgot_password.html')


def reset_password_view(request):
    """Step 2: User sets a new password after username verification."""
    ...
    if request.method == 'POST':
        ...
        if len(new_password) < 6:
            return render(request, 'vehicle/reset_password.html', {
                'username': username,
    ...
    return render(request, 'vehicle/reset_password.html', {'username': username})
